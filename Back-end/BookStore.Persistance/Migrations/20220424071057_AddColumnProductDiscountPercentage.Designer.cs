...
namespace App.Migrations
{
    ...
    [Migration("20220424071057_AddColumnProductDiscountPercentage")]
    partial class AddColumnProductDiscountPercentage
    {
            ...
            modelBuilder.Entity("BookStore.Domain.Entities.Battles.Vote", b =>
                {
                    ...
                    b.HasIndex("UserId", "BattleBookId")
                        .IsUnique()
            ...
            modelBuilder.Entity("BookStore.Domain.Entities.Subscription", b =>
                {
                    b.HasOne("BookStore.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("BookStore.Domain.Entities.Subscription", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
