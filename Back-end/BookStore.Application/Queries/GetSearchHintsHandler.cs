...
namespace BookStore.Application.Queries
{
    ...
    public class GetSearchHintsHandler : IRequestHandler<GetSearchHintsQuery, SearchHintsDto>
    {
        ...
        public GetSearchHintsHandler(DbFormEntityQueryBuilder<Book> bookQueryBuilder, 
