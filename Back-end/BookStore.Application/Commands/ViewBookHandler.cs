...
internal class ViewBookHandler : AsyncRequestHandler<ViewBookCommand>
{
    private int ViewIntervalInMinutes { get; }
    private ApplicationContext Context { get; }
    private LoggedUserAccessor LoggedUserAccessor { get; }

    public ViewBookHandler(ApplicationContext context, LoggedUserAccessor loggedUserAccessor,
