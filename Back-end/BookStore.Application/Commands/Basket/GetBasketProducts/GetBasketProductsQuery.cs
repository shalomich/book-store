...
internal class GetBasketProductsQueryHandler : IRequestHandler<GetBasketProductsQuery, IEnumerable<BasketProductDto>>
{
    ...
    public GetBasketProductsQueryHandler(LoggedUserAccessor loggedUserAccessor,
